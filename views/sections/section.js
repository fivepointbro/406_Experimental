export default class Sectionview extends HTMLElement {
    ...
    slug = 'section';  // page identifier
    data = ''; // name of data file, in same folder
    location = './views/sections/'; // you shouldn't need to touch this unless you change folder structures completely
    ...
    build() {
        ...
        $.HTML(this.location + 'section.html')
            .then(response => {
